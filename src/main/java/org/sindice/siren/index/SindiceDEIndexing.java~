 ...
 */
public class SindiceDEIndexing extends IndexingMMLab {
	
  private final long MAX_ENTITY_SIZE = 64L*1048576L;
 ...
 * @throws SolrServerException 
   */
  public SindiceDEIndexing(File inputDir, String url) throws IOException, SolrServerException {
    super(inputDir, url);
  }
        ...
        do {
          ...
          if (entity.sbMetadata.length() == 0) {
            ...
            entity.subject = entity.sbMetadata.substring(newLine + 1);
            	...
            	logger.error(entity.sbMetadata.toString() + ": index of \n");
